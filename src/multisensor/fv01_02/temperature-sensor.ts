// Created from: src/interfaces/module_2_0_MULTISENSOR_fv01_02.xml, object name="TEMPERATURE_SENSOR"
...
declare class TemperatureSensorRaw {
...
interface ITemperatureSensor {
    ...
    /** Wartość temperatury otoczenia w zakresie od 0.0 °C do 45.0 °C */
...
class TemperatureSensor implements ITemperatureSensor {
    ...
    constructor(private raw: TemperatureSensorRaw) {
...
class TemperatureSensorRemote implements ITemperatureSensor {
...
export { TemperatureSensor, TemperatureSensorRaw, TemperatureSensorRemote, StatisticStateType }
