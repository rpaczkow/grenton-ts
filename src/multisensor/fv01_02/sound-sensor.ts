// Created from: src/interfaces/module_2_0_MULTISENSOR_fv01_02.xml, object name="SOUND_SENSOR"
...
declare class SoundSensorRaw {
    add_event(event: EventType, callback: () => void): void;
    get(property: PropertyType): any;
    set(property: PropertyType, value: any): void;
}

interface ISoundSensor {
    /**
    ...
    /** Wartość natężenia dźwięku w zakresie od 30 do 130 dB */
    readonly value: number
    /** Wielkość histerezy (dokładność 0.1 dB) określająca czułość, przy której następuje wygenerowanie zdarzeń: OnValueChange, OnValueLower, OnValueRise */
    threshold: number
...
class SoundSensor implements ISoundSensor {
    ...
    constructor(private raw: SoundSensorRaw) {
...
class SoundSensorRemote implements ISoundSensor {
...
export { SoundSensor, SoundSensorRaw, SoundSensorRemote, StatisticStateType }
