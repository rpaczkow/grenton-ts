// Created from: src/interfaces/module_2_0_MULTISENSOR_fv01_02.xml, object name="HUMIDITY_SENSOR"
...
declare class HumiditySensorRaw {
...
interface IHumiditySensor {
    ...
    /** Wartość wilgotności powietrza w zakresie od 0 do 100 % */
...
class HumiditySensor implements IHumiditySensor {
    ...
    constructor(private raw: HumiditySensorRaw) {
...
class HumiditySensorRemote implements IHumiditySensor {
...
export { HumiditySensor, HumiditySensorRaw, HumiditySensorRemote, StatisticStateType }
