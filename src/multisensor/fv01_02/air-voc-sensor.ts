// Created from: src/interfaces/module_2_0_MULTISENSOR_fv01_02.xml, object name="AIR_VOC_SENSOR"
...
declare class AirVocSensorRaw {
    add_event(event: EventType, callback: () => void): void;
    get(property: PropertyType): any;
    set(property: PropertyType, value: any): void;
}

interface IAirVocSensor {
    /**
    ...
    /** Wartość lotnych związków organicznych (VOC) w zakresie od 0 do 60000 ppb */
    readonly value: number
    /** Wielkość histerezy (dokładność 1 ppb) określająca czułość, przy której następuje wygenerowanie zdarzeń: OnValueChange, OnValueLower, OnValueRise */
    threshold: number
...
class AirVocSensor implements IAirVocSensor {
    ...
    constructor(private raw: AirVocSensorRaw) {
...
class AirVocSensorRemote implements IAirVocSensor {
...
export { AirVocSensor, AirVocSensorRaw, AirVocSensorRemote, StatisticStateType }
