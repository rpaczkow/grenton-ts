// Created from: src/interfaces/module_grenton_v2_led_zwave_ff.xml, object name="ZWAVE_LED"
...
enum MethodType {
    ...
    Switch = 3,
    HoldValue = 4,
    ClearOvercurrentProtection = 5
}

declare class ZwaveLedRaw {
...
class ZwaveLed implements IZwaveLed {
    ...
    constructor(private raw: ZwaveLedRaw) {
    ...
    holdValue(ramp: number = 500): void { this.raw.execute(MethodType.HoldValue, ramp); }
    clearOvercurrentProtection(): void { this.raw.execute(MethodType.ClearOvercurrentProtection); }
}

class ZwaveLedRemote implements IZwaveLed {
...
export { ZwaveLed, ZwaveLedRaw, ZwaveLedRemote, StatisticStateType }
