// Created from: src/interfaces/module_2_0_ROLLER_SHUTTER_DIN_3_fv03_02.xml, object name="PowerSupplyVoltage"
...
interface IPowerSupplyVoltage {
    ...
    /**
     * Zdarzenie wywoływane gdy napięcie zasilania znajduje się poza wyznaczonym zakresem (MinValue - MaxValue)
     * @param callback
     */
    ...
    minValue: number
    /**
     * Ustawia wartość cechy MinValue
     * @param {number} value
     */
