// Created from: src/interfaces/module_2_0_GRENTON_SWITCH_fv01_02.xml, object name="SWITCH"
...
class Switch implements ISwitch {
    ...
    constructor(private raw: SwitchRaw) {
...
class SwitchRemote implements ISwitch {
...
export {
    Switch, SwitchRaw, SwitchRemote, StatisticStateType
}
