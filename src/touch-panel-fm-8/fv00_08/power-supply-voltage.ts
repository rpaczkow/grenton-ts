// Created from: src/interfaces/module_TOUCH_PANEL_PLUS_FM_8_fv00_08.xml, object name="PowerSupplyVoltage"
...
interface IPowerSupplyVoltage {
    ...
    /**
     * Zdarzenie wywoływane gdy napięcie zasilania osiągnie wartość MaxValue
     * @param callback
     */
    addOnSwitchOn: (callback: () => void) => void
    /**
     * Zdarzenie wywoływane gdy napięcie zasilania osiągnie wartość MinValue
     * @param callback
     */
