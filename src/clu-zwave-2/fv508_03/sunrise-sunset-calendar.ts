// Created from: src/interfaces/object_sunrise_sunset_calendar_v2.xml, object name="SunriseSunsetCalendar" version="2"
...
interface ISunriseSunsetCalendar {
    ...
    /** 0 - noc, 1 - dzień Na podstawie lokalnego wschodu/zachodu słońca (± 5 minut). Nie uwzględnia offsetów SunriseOffset/SunsetOffset -1 - Brak możliwości wyliczenia dla ustawionej lokalizacji */
    readonly isDayNow: number
    /** Przesunięcie zdarzenia wschodu słońca OnSunrise (w minutach), zakres -1439 do 1439 */
    sunriseOffset: number
    /** Przesunięcie zdarzenia zachodu słońca OnSunset (w minutach), zakres -1439 do 1439 */
    sunsetOffset: number
