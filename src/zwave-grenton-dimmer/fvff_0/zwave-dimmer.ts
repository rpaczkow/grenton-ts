// Created from: src/interfaces/module_grenton_dimmer_zwave_ff.xml, object name="ZWAVE_DIMMER"
...
interface IZwaveDimmer {
    ...
    /** Wykonuje przypisane komendy gdy ustawiana wartość jest spoza przedziału (MinValue - MaxValue) */
...
class ZwaveDimmer implements IZwaveDimmer {
    ...
    hold(rampTime: number = 500): void {
        this.raw.execute(MethodType.Hold, rampTime);
    }
    holdUp(rampTime: number = 500): void {
