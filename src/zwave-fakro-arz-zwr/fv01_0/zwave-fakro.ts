// Created from: src/interfaces/module_fakro_arz_zwr_01.xml, object name="ZWAVE_FAKRO"
...
interface IZwaveFakro {
    /** Zdarzenie wywoływane w momencie zmiany stanu rolety */
    ...
    /** Wartość procentowa otwarcia rolety, gdzie:\n0% - roleta zamknięta,\n100% - roleta otwarta */
    percent: number
    /** Roleta do góry */
    up: () => void
    /** Roleta w dół */
    ...
    start: () => void
    /** Ustawia wartość procentową, gdzie 100% - roleta otwarta */
