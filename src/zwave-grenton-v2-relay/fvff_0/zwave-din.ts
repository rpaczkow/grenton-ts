// Created from: src/interfaces/module_grenton_v2_relay_zwave_ff.xml, object name="ZWAVE_DIN"
...
interface IZwaveDin {
    ...
    holdInterval: number
    /** Ustawia wewnętrzne połączenie pomiędzy wejściem a określonym wyjściem */
...
export { ZwaveDin, ZwaveDinRaw, ZwaveDinRemote, StandaloneType, StatisticStateType }
