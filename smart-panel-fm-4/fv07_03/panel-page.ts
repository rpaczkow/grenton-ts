// Created from: packages/grenton-api/interfaces/module_SMART_PANEL_FM_4_fv07_03.xml, object name="PANEL_PAGE" version="07.03"
...
interface IPanelPage {
    ...
    readonly object1CustomIcon: string
    /**
     * Ustawia nazwę ikony użytkownika dla termostatu obsługiwanego przez strony Smart Panelu
     * @param {string} value
     */
    setObject1CustomIcon: (value: string) => void
    ...
    /** Ustawia nazwę ikony użytkownika dla termostatu obsługiwanego przez strony Smart Panelu */
    readonly object2CustomIcon: string
    /**
     * Ustawia nazwę ikony użytkownika dla termostatu obsługiwanego przez strony Smart Panelu
     * @param {string} value
     */
    setObject2CustomIcon: (value: string) => void
    /** Grupa Distributed Logic - grupa broadcastowa dla rozproszonej logiki */
    ...
    /** Ustawia nazwę ikony użytkownika dla termostatu obsługiwanego przez strony Smart Panelu */
    readonly object3CustomIcon: string
    /**
     * Ustawia nazwę ikony użytkownika dla termostatu obsługiwanego przez strony Smart Panelu
     * @param {string} value
     */
    setObject3CustomIcon: (value: string) => void
    /** Grupa Distributed Logic - grupa broadcastowa dla rozproszonej logiki */
    ...
    /** Ustawia nazwę ikony użytkownika dla termostatu obsługiwanego przez strony Smart Panelu */
    readonly object4CustomIcon: string
    /**
     * Ustawia nazwę ikony użytkownika dla termostatu obsługiwanego przez strony Smart Panelu
     * @param {string} value
     */
    setObject4CustomIcon: (value: string) => void
    /** Grupa Distributed Logic - grupa broadcastowa dla rozproszonej logiki */
