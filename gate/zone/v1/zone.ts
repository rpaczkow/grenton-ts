// Created from: packages/grenton-api/interfaces/object_zone_v1.xml, object name="Zone" version="1"
...
class Zone implements IZone {
    ...
    constructor(private raw: ZoneRaw) {
...
class ZoneRemote implements IZone {
