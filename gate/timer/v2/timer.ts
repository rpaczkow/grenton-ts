// Created from: packages/grenton-api/interfaces/object_gate_timer_v2.xml, object name="Timer" version="2"
...
interface ITimer {
    ...
    mode: ModeType
    /** Aktualny stan pracy timera: 0 - zatrzymany (stopped), 1 - liczy (counting) */
